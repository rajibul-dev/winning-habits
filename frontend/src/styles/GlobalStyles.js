...
:root {
  ...
  &.dark-mode {
    ...
    --color-brand-500-modified-1: #5b5ee6;
    --color-brand-500-modified-1-shadow: rgba(91, 93, 230, 0.4);
    ...
    --color-amber-500: #f59e0b; /* 7-20 streak fire color */
    ...
    /* BORDERS */
    --usual-layout-border: 1px solid var(--color-grey-300);
  }
